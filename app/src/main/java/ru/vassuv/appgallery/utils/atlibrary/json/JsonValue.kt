...
//    object DateSerializer: KSerializer<JsonValue> {
//        override val serialClassDesc: KSerialClassDesc = SerialClassDescImpl("ru.vassuv.appgallery.utils.atlibrary.json.JsonValue")
//
//        override fun save(output: KOutput, obj: JsonValue) {
//            output.writeStringValue(obj.toString())
//        }
//
//        override fun load(input: KInput): JsonValue {
//            return JsonObject.readFrom(input.readStringValue())
//        }
//    }
}
